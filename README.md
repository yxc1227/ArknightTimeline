...
php artisan test                          # 运行测试（285 项 / 2265 断言）
...
- **测试**：PHPUnit 12（285 项 / 2265 断言，含种子数据完整性与守卫测试）
...
| **《大地巡旅》**（官方世界观设定集） | 24+31 | 散文卷（世界卷 / 国家与地区卷）**年份普遍未载** → `unknown`；书末附录「泰拉纪年」提供 797–1099 官方年表 → `confirmed` 且附逐字引文，引文均已定位到语料的具体行 | 散文卷 `needs_review`，年表卷 `verified` |
