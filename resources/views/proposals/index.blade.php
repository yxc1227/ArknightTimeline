        ...
        <div class="panel">
            <div class="panel__title">
                ...
                <span class="stats-line">
                    <span>待审阅 {{ $counters['pending'] }}</span>
                    <span>疑似重复 {{ $counters['duplicate'] }}</span>
                    <span>出处缺失 {{ $counters['unverified'] }}</span>
                    <span>已入库 {{ $counters['applied'] }}</span>
                    <span>已驳回 {{ $counters['rejected'] }}</span>
                </span>
            </div>
                ...
                @forelse ($proposals as $proposal)
                    ...
                    <div class="proposal">
                        ...
                        <div class="proposal__body">
                            ...
                            <div class="section-label">出处核验（第 3 层校验：原文可定位）</div>
                            ...
                            <div class="section-label">校验明细</div>
                            <dl class="kv">
                            ...
                            @if (! empty($proposal->validation['anomalies']))
                                <div class="section-label">一致性预检（第 4 层）</div>
